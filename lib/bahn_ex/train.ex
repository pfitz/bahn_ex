defmodule BahnEx.Train do
  ...
  @type t :: %__MODULE__{name: String.t, type: String.t, boardId: non_neg_integer(), stopId: non_neg_integer(), stopName: String.t, dateTime: Calendar.datetime, origin: String.t, track: String.t, detailsId: String.t}
